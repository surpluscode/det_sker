...
Scenario: The application has an index page displaying events
  ...
  |title|short_description|long_description|location|start_time|end_time|category|
  |Massive party |a really good party|a really very good party|ungdomshuset|DateTime.new|DateTime.new|party|
